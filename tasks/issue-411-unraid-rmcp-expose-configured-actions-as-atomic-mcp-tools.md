...
- [ ] **T1 — Add MCP projection mode configuration**
...
- [ ] **T2 — Generate one focused schema per enabled action**
  Depends on: T1.
...
- [ ] **T3 — Route atomic calls through the existing dispatcher**
  Depends on: T2.
...
- [ ] **T4 — Preserve auth, destructive confirmation, and truthful annotations**
  Depends on: T3.
...
- [ ] **T5 — Add legacy/atomic parity contract tests**
  Depends on: T3, T4.
...
- [ ] **T6 — Document rollout and generated MCP help**
  Depends on: T1–T5.
