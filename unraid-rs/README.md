...
- `docs/dynamic-mcp/README.md` is the complete design package for runtime schema-driven MCP tools, including the contract, specification, types, models, schemas, research, and 92-task implementation plan.
